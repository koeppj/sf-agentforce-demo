...
- Page `/hr-request` embeds `HR_New_Hire_Intake`. Finish on that Flow navigates to Experience Cloud Home (`c:hrNavigateToPortalHome`); it must not restart the interview on this page.
